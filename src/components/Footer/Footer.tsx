            ...
            <div className="flex flex-col gap-10 500:gap-10 500:flex-row">
                <div className="w-full 500:w-[80%] 600:w-[90%]">
                    <div className="w-full mt-1 flex gap-1">
                        <img rel="icon" src="favicon.png" className="w-10  800:w-5"></img>
                        <p className="font-fira text-white text-[25px] 800:text-[12px]">Umer</p>
                        <p className="font-fira text-white text-[25px] 800:text-[12px]">Sadiq</p> 
                    ...
                    <div className="w-full justify-start items-start mt-3">
                        <p className="font-fira text-white text-[18px] 800:text-[12px]">Web designer and front-end developer</p>
                    </div>
                </div>
                <div className="w-full 500:w-[30%] 600:w-[10%] gap-1 flex flex-col 600:justify-start 600:items-start p-0">
                    ...
                    <div className="flex gap-2">
                        ...
                        className="w-10 500:w-7
                        cursor-pointer flex justify-center items-center rounded-[3px] hover:bg-background-2">
                            <img rel="icon" src="whatsapp.svg" className="w-10 500:w-7  600:w-6"></img>
                        </a>
                        <a href={mailtoLink} target="_blank"
                        className="w-14 600:w-8 500:w-9 
                        cursor-pointer
                        rounded-[3px] hover:bg-background-2">
                            <img rel="icon" src="Email.svg" className="w-14 500:w-9  600:w-8"></img>
                        </a>
                        <a href="https://www.linkedin.com/in/umer-sadiq-619615386" target="_blank" 
                        className="w-11 500:w-8 600:w-7
                        cursor-pointer flex justify-center items-center rounded-[3px] hover:bg-background-2">
                            <img rel="icon" src="Linkedin.svg" className="w-11 500:w-8 600:w-7"></img>
                        </a>
